...
DATA(insert OID = 8891 (  dictionary_pipe_to_text	PGNSP PGUID 12 100 0 0 0 f f f f t f s s 2 0 25 "26 23" _null_ _null_ _null_ _null_ _null_ dictionary_pipe_to_text _null_ _null_ _null_ ));
DESCR("returns text representation of dictionary pipe");
